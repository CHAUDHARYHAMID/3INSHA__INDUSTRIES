      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">Insha Industries</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-primary-foreground/80">123 Industrial Zone, Factory Lane, City, Country</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-3 h-5 w-5 text-accent" />
                <span className="text-primary-foreground/80">+1 (234) 567-890</span>
              </li>
              <li className="flex items-center">
